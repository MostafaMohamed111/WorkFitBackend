...
internal sealed class InvalidAssessmentStatusTransitionDomainException(AssessmentStatus currentStatus, AssessmentStatus attemptedStatus) : DomainException(
